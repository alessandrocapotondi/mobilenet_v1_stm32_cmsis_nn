...
static const uint8_t conv3_wt[CONV3_KER_DIM * CONV3_KER_DIM * CONV3_IM_CH * CONV3_OUT_CH>>LAYER3_WT_SHIFT] = CONV3_WT;
static const int32_t conv3_bias[CONV3_OUT_CH] = CONV3_BIAS;

//Layer 4	Conv dw/ s2
static const uint8_t conv4_wt[CONV4_KER_DIM * CONV4_KER_DIM * 1 * CONV4_OUT_CH>>LAYER4_WT_SHIFT] = CONV4_WT;
...
static const uint8_t conv7_wt[CONV7_KER_DIM * CONV7_KER_DIM * CONV7_IM_CH * CONV7_OUT_CH>>LAYER7_WT_SHIFT] = CONV7_WT;
static const int32_t conv7_bias[CONV7_OUT_CH] = CONV7_BIAS;

//Layer 8	Conv dw/ s2
static const uint8_t conv8_wt[CONV8_KER_DIM * CONV8_KER_DIM * 1 * CONV8_OUT_CH>>LAYER8_WT_SHIFT] = CONV8_WT;
static const int32_t conv8_bias[CONV8_OUT_CH] = CONV8_BIAS;

//Layer 9	Conv Point/ s1
static const uint8_t conv9_wt[CONV9_KER_DIM * CONV9_KER_DIM * CONV9_IM_CH * CONV9_OUT_CH>>LAYER9_WT_SHIFT] = CONV9_WT;
static const int32_t conv9_bias[CONV9_OUT_CH] = CONV9_BIAS;

//Layer 10	Conv dw/ s1
static const uint8_t conv10_wt[CONV10_KER_DIM * CONV10_KER_DIM * 1 * CONV10_OUT_CH>>LAYER10_WT_SHIFT] = CONV10_WT;
static const int32_t conv10_bias[CONV10_OUT_CH] = CONV10_BIAS;

//Layer 11	Conv Point/ s1
static const uint8_t conv11_wt[CONV11_KER_DIM * CONV11_KER_DIM * CONV11_IM_CH * CONV11_OUT_CH>>LAYER11_WT_SHIFT] = CONV11_WT;
static const int32_t conv11_bias[CONV11_OUT_CH] = CONV11_BIAS;

//Layer 12	Conv dw/ s2
static const uint8_t conv12_wt[CONV12_KER_DIM * CONV12_KER_DIM * 1 * CONV12_OUT_CH>>LAYER12_WT_SHIFT] = CONV12_WT;
static const int32_t conv12_bias[CONV12_OUT_CH] = CONV12_BIAS;

//Layer 13	Conv Point/ s1
static const uint8_t conv13_wt[CONV13_KER_DIM * CONV13_KER_DIM * CONV13_IM_CH * CONV13_OUT_CH>>LAYER13_WT_SHIFT] = CONV13_WT;
static const int32_t conv13_bias[CONV13_OUT_CH] = CONV13_BIAS;

//Layer 14	Conv dw/ s1
static const uint8_t conv14_wt[CONV14_KER_DIM * CONV14_KER_DIM * 1 * CONV14_OUT_CH>>LAYER14_WT_SHIFT] = CONV14_WT;
static const int32_t conv14_bias[CONV14_OUT_CH] = CONV14_BIAS;

//Layer 15	Conv Point/ s1
static const uint8_t conv15_wt[CONV15_KER_DIM * CONV15_KER_DIM * CONV15_IM_CH * CONV15_OUT_CH>>LAYER15_WT_SHIFT] = CONV15_WT;
static const int32_t conv15_bias[CONV15_OUT_CH] = CONV15_BIAS;

//Layer 16	Conv dw/ s1
static const uint8_t conv16_wt[CONV16_KER_DIM * CONV16_KER_DIM * 1 * CONV16_OUT_CH>>LAYER16_WT_SHIFT] = CONV16_WT;
static const int32_t conv16_bias[CONV16_OUT_CH] = CONV16_BIAS;

//Layer 17	Conv Point/ s1
static const uint8_t conv17_wt[CONV17_KER_DIM * CONV17_KER_DIM * CONV17_IM_CH * CONV17_OUT_CH>>LAYER17_WT_SHIFT] = CONV17_WT;
static const int32_t conv17_bias[CONV17_OUT_CH] = CONV17_BIAS;

//Layer 18	Conv dw/ s1
static const uint8_t conv18_wt[CONV18_KER_DIM * CONV18_KER_DIM * 1 * CONV18_OUT_CH>>LAYER18_WT_SHIFT] = CONV18_WT;
static const int32_t conv18_bias[CONV18_OUT_CH] = CONV18_BIAS;

//Layer 19	Conv Point/ s1
static const uint8_t conv19_wt[CONV19_KER_DIM * CONV19_KER_DIM * CONV19_IM_CH * CONV19_OUT_CH>>LAYER18_WT_SHIFT] = CONV19_WT;
static const int32_t conv19_bias[CONV19_OUT_CH] = CONV19_BIAS;

//Layer 20	Conv dw/ s1
static const uint8_t conv20_wt[CONV20_KER_DIM * CONV20_KER_DIM * 1 * CONV20_OUT_CH>>LAYER20_WT_SHIFT] = CONV20_WT;
static const int32_t conv20_bias[CONV20_OUT_CH] = CONV20_BIAS;

//Layer 21	Conv Point/ s1
static const uint8_t conv21_wt[CONV21_KER_DIM * CONV21_KER_DIM * CONV21_IM_CH * CONV21_OUT_CH>>LAYER21_WT_SHIFT] = CONV21_WT;
static const int32_t conv21_bias[CONV21_OUT_CH] = CONV21_BIAS;

//Layer 22	Conv dw/ s1
static const uint8_t conv22_wt[CONV22_KER_DIM * CONV22_KER_DIM * 1 * CONV22_OUT_CH>>LAYER22_WT_SHIFT] = CONV22_WT;
static const int32_t conv22_bias[CONV22_OUT_CH] = CONV22_BIAS;

//Layer 23	Conv Point/ s1
static const uint8_t conv23_wt[CONV23_KER_DIM * CONV23_KER_DIM * CONV23_IM_CH * CONV23_OUT_CH>>LAYER23_WT_SHIFT] = CONV23_WT;
static const int32_t conv23_bias[CONV23_OUT_CH] = CONV23_BIAS;

//Layer 24	Conv dw/ s2
static const uint8_t conv24_wt[CONV24_KER_DIM * CONV24_KER_DIM * 1 * CONV24_OUT_CH>>LAYER24_WT_SHIFT] = CONV24_WT;
static const int32_t conv24_bias[CONV24_OUT_CH] = CONV24_BIAS;

//Layer 25	Conv Point/ s1
static const uint8_t conv25_wt[CONV25_KER_DIM * CONV25_KER_DIM * CONV25_IM_CH * CONV25_OUT_CH>>LAYER25_WT_SHIFT] = CONV25_WT;
static const int32_t conv25_bias[CONV25_OUT_CH] = CONV25_BIAS;

//Layer 26	Conv dw/ s1
static const uint8_t conv26_wt[CONV26_KER_DIM * CONV26_KER_DIM * 1 * CONV26_OUT_CH>>LAYER26_WT_SHIFT] = CONV26_WT;
static const int32_t conv26_bias[CONV26_OUT_CH] = CONV26_BIAS;

//Layer 27	Conv Point/ s1
static const uint8_t conv27_wt[CONV27_KER_DIM * CONV27_KER_DIM * CONV27_IM_CH * CONV27_OUT_CH>>LAYER27_WT_SHIFT] = CONV27_WT;
...
int main(void)
{
	...
	while(1) {
		...
		uint8_t *tensorOut = l2_tensor_scratch + L2_TENSOR_IO_SIZE - (CONV1_OUT_DIM*CONV1_OUT_DIM*CONV1_OUT_CH>>LAYER1_OUT_SHIFT);
		...
		*/
		...
		USR_CHECKSUM(tensorOut,CONV1_OUT_DIM*CONV1_OUT_DIM*CONV1_OUT_CH,layerId, 8 >> LAYER1_OUT_SHIFT); layerId++;
...
*/
		LAYER2();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV2_OUT_DIM*CONV2_OUT_DIM*CONV2_OUT_CH,layerId, 8 >> LAYER2_OUT_SHIFT); layerId++;
...
*/
		LAYER3();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV3_OUT_DIM*CONV3_OUT_DIM*CONV3_OUT_CH,layerId,8 >> LAYER3_OUT_SHIFT); layerId++;
...
*/
		LAYER4();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV4_OUT_DIM*CONV4_OUT_DIM*CONV4_OUT_CH,layerId,8 >> LAYER4_OUT_SHIFT); layerId++;
...
*/
		LAYER5();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV5_OUT_DIM*CONV5_OUT_DIM*CONV5_OUT_CH,layerId,8 >> LAYER5_OUT_SHIFT); layerId++;
...
*/
		LAYER6();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV6_OUT_DIM*CONV6_OUT_DIM*CONV6_OUT_CH,layerId,8 >> LAYER6_OUT_SHIFT); layerId++;
...
*/
		LAYER7();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV7_OUT_DIM*CONV7_OUT_DIM*CONV7_OUT_CH,layerId,8 >> LAYER7_OUT_SHIFT); layerId++;
...
*/
		LAYER8();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV8_OUT_DIM*CONV8_OUT_DIM*CONV8_OUT_CH,layerId,8 >> LAYER8_OUT_SHIFT); layerId++;
...
*/
		LAYER9();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV9_OUT_DIM*CONV9_OUT_DIM*CONV9_OUT_CH,layerId, 8 >> LAYER9_OUT_SHIFT); layerId++;
...
*/
		LAYER10();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV10_OUT_DIM*CONV10_OUT_DIM*CONV10_OUT_CH,layerId, 8 >> LAYER10_OUT_SHIFT); layerId++;
...
*/
		LAYER11();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV11_OUT_DIM*CONV11_OUT_DIM*CONV11_OUT_CH,layerId, 8 >> LAYER11_OUT_SHIFT); layerId++;
...
*/
		LAYER12();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV12_OUT_DIM*CONV12_OUT_DIM*CONV12_OUT_CH,layerId, 8 >> LAYER12_OUT_SHIFT); layerId++;
...
*/
		LAYER13();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV13_OUT_DIM*CONV13_OUT_DIM*CONV13_OUT_CH,layerId, 8 >> LAYER13_OUT_SHIFT); layerId++;
...
*/
		LAYER14();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV14_OUT_DIM*CONV14_OUT_DIM*CONV14_OUT_CH,layerId, 8 >> LAYER14_OUT_SHIFT); layerId++;
...
*/
		LAYER15();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV15_OUT_DIM*CONV15_OUT_DIM*CONV15_OUT_CH,layerId, 8 >> LAYER15_OUT_SHIFT); layerId++;
...
*/
		LAYER16();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV16_OUT_DIM*CONV16_OUT_DIM*CONV16_OUT_CH,layerId, 8 >> LAYER16_OUT_SHIFT); layerId++;
...
*/
		LAYER17();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV17_OUT_DIM*CONV17_OUT_DIM*CONV17_OUT_CH,layerId, 8 >> LAYER17_OUT_SHIFT); layerId++;
...
*/
		LAYER18();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV18_OUT_DIM*CONV18_OUT_DIM*CONV18_OUT_CH,layerId, 8 >> LAYER18_OUT_SHIFT); layerId++;
		tensorIn  = tensorOut;
		if (!tensorId)
			tensorOut = l2_tensor_scratch;
		else
...
*/
		LAYER19();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV19_OUT_DIM*CONV19_OUT_DIM*CONV19_OUT_CH,layerId, 8 >> LAYER19_OUT_SHIFT); layerId++;
...
*/
		LAYER20();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV20_OUT_DIM*CONV20_OUT_DIM*CONV20_OUT_CH,layerId, 8 >> LAYER20_OUT_SHIFT); layerId++;
...
*/
		LAYER21();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV21_OUT_DIM*CONV21_OUT_DIM*CONV21_OUT_CH,layerId, 8 >> LAYER21_OUT_SHIFT); layerId++;
...
*/
		LAYER22();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV22_OUT_DIM*CONV22_OUT_DIM*CONV22_OUT_CH,layerId, 8 >> LAYER22_OUT_SHIFT); layerId++;
...
*/
		LAYER23();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV23_OUT_DIM*CONV23_OUT_DIM*CONV23_OUT_CH,layerId, 8 >> LAYER23_OUT_SHIFT); layerId++;
...
*/
		LAYER24();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV24_OUT_DIM*CONV24_OUT_DIM*CONV24_OUT_CH,layerId, 8 >> LAYER24_OUT_SHIFT); layerId++;
...
*/
		LAYER25();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV25_OUT_DIM*CONV25_OUT_DIM*CONV25_OUT_CH,layerId, 8 >> LAYER25_OUT_SHIFT); layerId++;
...
*/
		LAYER26();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV26_OUT_DIM*CONV26_OUT_DIM*CONV26_OUT_CH,layerId, 8 >> LAYER26_OUT_SHIFT); layerId++;
...
*/
		LAYER27();
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		USR_CHECKSUM(tensorOut,CONV27_OUT_DIM*CONV27_OUT_DIM*CONV27_OUT_CH,layerId, 8 >> LAYER27_OUT_SHIFT); layerId++;
